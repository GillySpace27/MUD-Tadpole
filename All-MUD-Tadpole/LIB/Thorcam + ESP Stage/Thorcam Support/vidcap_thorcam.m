function [img] = vidcap_thorcam( cam )
% Video Capture
%   This function will display the camera until the 's' key is pressed, at
%   which point it will output the image. It times out after 10,000 loops
