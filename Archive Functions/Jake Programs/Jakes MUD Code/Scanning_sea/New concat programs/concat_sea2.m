...
function [U1,phase1,B1,E_lam,t_f,w_f,lam_eq]=concat_sea2(Ew,tau1,w,lam0,H)
c=300;
N=size(Ew,2);
...
[Valid_unk,Valid_H,Valid_unk1,Valid_H1,Valid_unkN,Valid_HN,x]=temporal_filter_sea2(fftc(Ew),tw,size(Ew,2),Ht);
% Getting the retrieved amplitudes ready for concatenation by shifting them
% in time
%[U1,H1,g1]=add_phase_delay1(Valid_unk,tw,Valid_H,x,Valid_unk1,Valid_unkN);
[U1,H1,g1]=add_phase_delay2(Valid_unk,tw,Valid_H,x,Valid_unk1,Valid_unkN,Valid_H1,Valid_HN);
