...
function [Et,E_lam,t_f,lam_eq,amp,t1]=single_mud_ret3_sim(I1,Ref1,dl,N,lam0,tau,pks,dpks)

% first the AC terms of the traces are retrieved:
% the trace is FFT'd
Fint=fftc(I1);
[pks,x2]=lclmax(Norm(sum(abs(Fint),2)),10,.01);
...
x_c1=1;x_c2=length(Ew(:,1));x2=10;ymax=.1;
