...
%reffile = 'C:\Users\Chris\Dropbox\Spring 2015\Trebino\Pictures\2-18-15a\gref.jpg';
%interferogramfile = 'C:\Users\Chris\Dropbox\Spring 2015\Trebino\Pictures\2-18-15a\gvd.jpg';
...
%grenfile = 'C:\Users\Chris\Dropbox\Spring 2015\Trebino\Traces\FrogFile-18-Feb-2015-17-3-24.Speck.dat';
%grenfile = 'C:\Users\Chris\Dropbox\Spring 2015\Trebino\Traces\Gren Ref 2-18a\FrogFile-18-Feb-2015-17-27-47.Speck.dat';

%Add the reference phase?
phaseadd = 0;

%Add a bunch of spectral zeros?
addZeros = true;
...
%lowestLambda = 763.01e-9; %first wavelength on the camera
%lowestLambda = 758.5e-9; %works ok
lowestLambda = 756.5e-9;
...
plot_ew(blam(real),spect(real),uphi(real))
